		...
		public JsonElement serialize(Style p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_) {
			...
			if (p_serialize_1_.isEmpty()) {
				...
				if (p_serialize_1_.clickEvent != null) {
					...
					jsonobject1.addProperty("action", p_serialize_1_.clickEvent.action().getCanonicalName());
					jsonobject1.addProperty("value", p_serialize_1_.clickEvent.value());
					jsonobject.add("clickEvent", jsonobject1);
				}

				if (p_serialize_1_.hoverEvent != null) {
					JsonObject jsonobject2 = new JsonObject();
					jsonobject2.addProperty("action", p_serialize_1_.hoverEvent.action().getCanonicalName());
					jsonobject2.add("value", p_serialize_3_.serialize(p_serialize_1_.hoverEvent.value()));
