...
public class RedundantChanceTags implements IFixableData {
	...
	public NBTTagCompound fixTagCompound(NBTTagCompound compound) {
		...
		if (compound.hasKey("HandDropChances", 9)) {
			...
			if (nbttaglist.tagCount() == 2 && nbttaglist.getFloatAt(0) == 0F && nbttaglist.getFloatAt(1) == 0F) {
		...
		if (compound.hasKey("ArmorDropChances", 9)) {
			...
			if (nbttaglist1.tagCount() == 4 && nbttaglist1.getFloatAt(0) == 0F && nbttaglist1.getFloatAt(1) == 0F && nbttaglist1.getFloatAt(2) == 0F && nbttaglist1.getFloatAt(3) == 0F) {
