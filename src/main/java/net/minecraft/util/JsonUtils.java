...
public class JsonUtils {
	...
	public static <T> T gsonDeserialize(Gson gsonIn, Reader readerIn, Class<T> adapter) {
	...
	public static <T> T gsonDeserialize(Gson gsonIn, String json, Class<T> adapter) {
		...
		return gsonDeserialize(gsonIn, new StringReader(json), adapter);
	}
	
	public static <T> T gsonDeserialize(Gson gson, String string, Type type) {
		
		return fromJson(gson, string, type);
	}
