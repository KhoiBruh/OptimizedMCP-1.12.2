...
public class RegionFile
{
    ...
    public RegionFile(File fileNameIn)
    {
        ...
        try
        {
            ...
            sectorFree = Lists.<Boolean>newArrayListWithCapacity(i1);
            ...
            else
            {
                ...
                if (l1 != -1)
                {
                    for (int k1 = l1; k1 < sectorFree.size(); ++k1)
                    {
                        if (j1 != 0)
                        {
                            if (((Boolean) sectorFree.get(k1)).booleanValue())
                            {
                                ++j1;
                            }
                            else
                        ...
                        else if (((Boolean) sectorFree.get(k1)).booleanValue())
                        {
                            l1 = k1;
                            j1 = 1;
                        }
    ...
    {
        dataFile.seek((long)(sectorNumber * 4096));
    ...
    private void setChunkTimestamp(int x, int z, int timestamp) throws IOException
    {
        ...
        dataFile.seek((long)(4096 + (x + z * 32) * 4));
