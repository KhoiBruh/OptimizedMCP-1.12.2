...
public class ChunkGeneratorSettings {
	...
	public static class Factory {
		...
		public float lowerLimitScale = 512F;
		public float depthNoiseScaleX = 200F;
		public float depthNoiseScaleZ = 200F;
		public float depthNoiseScaleExponent = 0.5F;
		public float mainNoiseScaleX = 80F;
		public float mainNoiseScaleY = 160F;
		public float mainNoiseScaleZ = 80F;
		public float baseSize = 8.5F;
		public float stretchY = 12F;
		...
		public int hashCode() {
			...
			i = 31 * i + (lowerLimitScale == 0F ? 0 : Float.floatToIntBits(lowerLimitScale));
			i = 31 * i + (depthNoiseScaleX == 0F ? 0 : Float.floatToIntBits(depthNoiseScaleX));
			i = 31 * i + (depthNoiseScaleZ == 0F ? 0 : Float.floatToIntBits(depthNoiseScaleZ));
			i = 31 * i + (depthNoiseScaleExponent == 0F ? 0 : Float.floatToIntBits(depthNoiseScaleExponent));
			i = 31 * i + (mainNoiseScaleX == 0F ? 0 : Float.floatToIntBits(mainNoiseScaleX));
			i = 31 * i + (mainNoiseScaleY == 0F ? 0 : Float.floatToIntBits(mainNoiseScaleY));
			i = 31 * i + (mainNoiseScaleZ == 0F ? 0 : Float.floatToIntBits(mainNoiseScaleZ));
			i = 31 * i + (baseSize == 0F ? 0 : Float.floatToIntBits(baseSize));
			i = 31 * i + (stretchY == 0F ? 0 : Float.floatToIntBits(stretchY));
			i = 31 * i + (biomeDepthWeight == 0F ? 0 : Float.floatToIntBits(biomeDepthWeight));
			i = 31 * i + (biomeDepthOffset == 0F ? 0 : Float.floatToIntBits(biomeDepthOffset));
			i = 31 * i + (biomeScaleWeight == 0F ? 0 : Float.floatToIntBits(biomeScaleWeight));
			i = 31 * i + (biomeScaleOffset == 0F ? 0 : Float.floatToIntBits(biomeScaleOffset));
			i = 31 * i + seaLevel;
			i = 31 * i + (useCaves ? 1 : 0);
