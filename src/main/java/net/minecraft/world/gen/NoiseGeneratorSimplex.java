...
public class NoiseGeneratorSimplex {
	...
	private static final double F2 = 0.5D * (SQRT_3 - 1D);
	private static final double G2 = (3D - SQRT_3) / 6D;
	private final int[] p;
	public double xo;
	public double yo;
	public double zo;
	...
	public NoiseGeneratorSimplex(Random seed) {
		...
		p = new int[512];
		xo = seed.nextDouble() * 256D;
		yo = seed.nextDouble() * 256D;
		zo = seed.nextDouble() * 256D;
	...
	public double getValue(double p_151605_1_, double p_151605_3_) {
		...
		double d13 = d9 - 1D + 2D * d5;
		double d14 = d10 - 1D + 2D * d5;
		int i1 = i & 255;
		int j1 = j & 255;
		int k1 = p[i1 + p[j1]] % 12;
	...
	public void add(double[] p_151606_1_, double p_151606_2_, double p_151606_4_, int p_151606_6_, int p_151606_7_, double p_151606_8_, double p_151606_10_, double p_151606_12_) {
		...
		for (int j = 0; j < p_151606_7_; ++j) {
			...
			for (int k = 0; k < p_151606_6_; ++k) {
				...
				double d13 = d9 - 1D + 2D * G2;
				double d14 = d10 - 1D + 2D * G2;
				int l1 = l & 255;
				int i2 = i1 & 255;
				int j2 = p[l1 + p[i2]] % 12;
				...
				int i3 = i++;
				p_151606_1_[i3] += 70D * (d2 + d3 + d4) * p_151606_12_;
			}
		}
	}
