...
public class BiomeJungle extends Biome {
	...
	public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
		...
		if (rand.nextInt(10) == 0) {
			...
			return !isEdge && rand.nextInt(3) == 0 ? new WorldGenMegaJungle(false, 10, 20, JUNGLE_LOG, JUNGLE_LEAF) : new WorldGenTrees(false, 4 + rand.nextInt(7), JUNGLE_LOG, JUNGLE_LEAF, true);
		}
	}
