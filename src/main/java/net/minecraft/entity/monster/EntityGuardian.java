...
public class EntityGuardian extends EntityMob
{
    ...
    {
        return ((Boolean) dataManager.get(MOVING)).booleanValue();
    }
    ...
    {
        return ((Integer) dataManager.get(TARGET_ENTITY)).intValue() != 0;
    }
    ...
    public EntityLivingBase getTargetedEntity()
    {
        ...
        else if (world.isRemote)
        {
            ...
            {
                Entity entity = world.getEntityByID(((Integer) dataManager.get(TARGET_ENTITY)).intValue());
    ...
    {
        if (!isMoving() && !source.isMagicDamage() && source.getImmediateSource() instanceof EntityLivingBase)
        {
    ...
    static class AIGuardianAttack extends EntityAIBase
    {
        ...
        public void resetTask()
        {
            ...
            guardian.setAttackTarget((EntityLivingBase)null);
    ...
    static class GuardianMoveHelper extends EntityMoveHelper
    {
        ...
        public void onUpdateMoveHelper()
        {
            if (action == EntityMoveHelper.Action.MOVE_TO && !entityGuardian.getNavigator().noPath())
            {
                ...
                double d5 = Math.cos((double)(entityGuardian.rotationYaw * 0.017453292F));
                double d6 = Math.sin((double)(entityGuardian.rotationYaw * 0.017453292F));
