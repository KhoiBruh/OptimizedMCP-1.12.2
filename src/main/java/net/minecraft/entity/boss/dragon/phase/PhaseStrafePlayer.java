        ...
        else
        {
            ...
            if (attackTarget.getDistanceSq(dragon) < 4096.0D)
            {
                if (dragon.canEntityBeSeen(attackTarget))
                {
                    ...
                    Vec3d vec3d = (new Vec3d((double)MathHelper.sin(dragon.rotationYaw * 0.017453292F), 0.0D, (double)(-MathHelper.cos(dragon.rotationYaw * 0.017453292F)))).normalize();
                    ...
                    if (fireballCharge >= 5 && f >= 0.0F && f < 10.0F)
                    {
                        ...
                        double d6 = dragon.dragonPartHead.posX - vec3d2.x * 1.0D;
                        double d7 = dragon.dragonPartHead.posY + (double)(dragon.dragonPartHead.height / 2.0F) + 0.5D;
                        double d8 = dragon.dragonPartHead.posZ - vec3d2.z * 1.0D;
                        ...
                        dragon.world.playEvent((EntityPlayer)null, 1017, new BlockPos(dragon), 0);
