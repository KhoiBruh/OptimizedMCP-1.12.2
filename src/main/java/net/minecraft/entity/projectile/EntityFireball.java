...
public abstract class EntityFireball extends Entity
{
    ...
    {
        compound.setTag("direction", newDoubleNBTList(new double[] {motionX, motionY, motionZ}));
        compound.setTag("power", newDoubleNBTList(new double[] {accelerationX, accelerationY, accelerationZ}));
    ...
    public boolean attackEntityFrom(DamageSource source, float amount)
    {
        ...
        else
        {
            ...
            if (source.getTrueSource() != null)
            {
                ...
                {
                    shootingEntity = (EntityLivingBase)source.getTrueSource();
                }
