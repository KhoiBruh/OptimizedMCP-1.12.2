        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        Vec3d vec3d = RandomPositionGenerator.findRandomTargetBlockTowards(entity, 10, 7, new Vec3d((double) doorInfo.getDoorBlockPos().getX(), (double) doorInfo.getDoorBlockPos().getY(), (double) doorInfo.getDoorBlockPos().getZ()));
