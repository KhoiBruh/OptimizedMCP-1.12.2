...
public class EntityFireworkRocket extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if (isAttachedToEntity())
        {
            ...
            {
                Entity entity = world.getEntityByID(((Integer) dataManager.get(BOOSTED_ENTITY_ID)).intValue());
        ...
        {
            world.playSound((EntityPlayer)null, posX, posY, posZ, SoundEvents.ENTITY_FIREWORK_LAUNCH, SoundCategory.AMBIENT, 3.0F, 1.0F);
        }
    ...
    {
        return ((Integer) dataManager.get(BOOSTED_ENTITY_ID)).intValue() > 0;
    }
