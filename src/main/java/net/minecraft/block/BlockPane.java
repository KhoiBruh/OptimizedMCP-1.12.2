...
public class BlockPane extends Block {
	...
	protected static final AxisAlignedBB[] AABB_BY_INDEX = new AxisAlignedBB[]{new AxisAlignedBB(0.4375D, 0D, 0.4375D, 0.5625D, 1D, 0.5625D), new AxisAlignedBB(0.4375D, 0D, 0.4375D, 0.5625D, 1D, 1D), new AxisAlignedBB(0D, 0D, 0.4375D, 0.5625D, 1D, 0.5625D), new AxisAlignedBB(0D, 0D, 0.4375D, 0.5625D, 1D, 1D), new AxisAlignedBB(0.4375D, 0D, 0D, 0.5625D, 1D, 0.5625D), new AxisAlignedBB(0.4375D, 0D, 0D, 0.5625D, 1D, 1D), new AxisAlignedBB(0D, 0D, 0D, 0.5625D, 1D, 0.5625D), new AxisAlignedBB(0D, 0D, 0D, 0.5625D, 1D, 1D), new AxisAlignedBB(0.4375D, 0D, 0.4375D, 1D, 1D, 0.5625D), new AxisAlignedBB(0.4375D, 0D, 0.4375D, 1D, 1D, 1D), new AxisAlignedBB(0D, 0D, 0.4375D, 1D, 1D, 0.5625D), new AxisAlignedBB(0D, 0D, 0.4375D, 1D, 1D, 1D), new AxisAlignedBB(0.4375D, 0D, 0D, 1D, 1D, 0.5625D), new AxisAlignedBB(0.4375D, 0D, 0D, 1D, 1D, 1D), new AxisAlignedBB(0D, 0D, 0D, 1D, 1D, 0.5625D), new AxisAlignedBB(0D, 0D, 0D, 1D, 1D, 1D)};
