...
public class ModelOcelot extends ModelBase {
	...
	public ModelOcelot() {
		...
		ocelotHead.addBox("main", -2.5F, -2F, -3F, 5, 4, 5);
		ocelotHead.addBox("nose", -1.5F, 0F, -4F, 3, 2, 2);
		ocelotHead.addBox("ear1", -2F, -3F, 0F, 1, 1, 2);
		ocelotHead.addBox("ear2", 1F, -3F, 0F, 1, 1, 2);
		ocelotHead.setRotationPoint(0F, 15F, -9F);
		ocelotBody = new ModelRenderer(this, 20, 0);
		ocelotBody.addBox(-2F, 3F, -8F, 4, 16, 6, 0F);
		ocelotBody.setRotationPoint(0F, 12F, -10F);
		ocelotTail = new ModelRenderer(this, 0, 15);
		ocelotTail.addBox(-0.5F, 0F, 0F, 1, 8, 1);
		ocelotTail.rotateAngleX = 0.9F;
		ocelotTail.setRotationPoint(0F, 15F, 8F);
		ocelotTail2 = new ModelRenderer(this, 4, 15);
		ocelotTail2.addBox(-0.5F, 0F, 0F, 1, 8, 1);
		ocelotTail2.setRotationPoint(0F, 20F, 14F);
		ocelotBackLeftLeg = new ModelRenderer(this, 8, 13);
		ocelotBackLeftLeg.addBox(-1F, 0F, 1F, 2, 6, 2);
		ocelotBackLeftLeg.setRotationPoint(1.1F, 18F, 5F);
		ocelotBackRightLeg = new ModelRenderer(this, 8, 13);
		ocelotBackRightLeg.addBox(-1F, 0F, 1F, 2, 6, 2);
		ocelotBackRightLeg.setRotationPoint(-1.1F, 18F, 5F);
		ocelotFrontLeftLeg = new ModelRenderer(this, 40, 0);
		ocelotFrontLeftLeg.addBox(-1F, 0F, 0F, 2, 10, 2);
		ocelotFrontLeftLeg.setRotationPoint(1.2F, 13.8F, -5F);
		ocelotFrontRightLeg = new ModelRenderer(this, 40, 0);
		ocelotFrontRightLeg.addBox(-1F, 0F, 0F, 2, 10, 2);
		ocelotFrontRightLeg.setRotationPoint(-1.2F, 13.8F, -5F);
	}
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
		...
		ocelotHead.rotationPointY = 15F;
		ocelotHead.rotationPointZ = -9F;
		ocelotTail.rotationPointY = 15F;
		ocelotTail.rotationPointZ = 8F;
		ocelotTail2.rotationPointY = 20F;
		ocelotTail2.rotationPointZ = 14F;
		ocelotFrontLeftLeg.rotationPointY = 13.8F;
		ocelotFrontLeftLeg.rotationPointZ = -5F;
		ocelotFrontRightLeg.rotationPointY = 13.8F;
		ocelotFrontRightLeg.rotationPointZ = -5F;
		ocelotBackLeftLeg.rotationPointY = 18F;
		ocelotBackLeftLeg.rotationPointZ = 5F;
		ocelotBackRightLeg.rotationPointY = 18F;
		ocelotBackRightLeg.rotationPointZ = 5F;
		ocelotTail.rotateAngleX = 0.9F;

		if (entityocelot.isSneaking()) {
			++ocelotBody.rotationPointY;
			ocelotHead.rotationPointY += 2F;
			++ocelotTail.rotationPointY;
			ocelotTail2.rotationPointY -= 4F;
			ocelotTail2.rotationPointZ += 2F;
			...
			ocelotBody.rotationPointY -= 4F;
			ocelotBody.rotationPointZ += 5F;
			ocelotHead.rotationPointY -= 3.3F;
			++ocelotHead.rotationPointZ;
			ocelotTail.rotationPointY += 8F;
			ocelotTail.rotationPointZ -= 2F;
			ocelotTail2.rotationPointY += 2F;
			...
			ocelotFrontLeftLeg.rotationPointZ = -7F;
			ocelotFrontRightLeg.rotateAngleX = -0.15707964F;
			ocelotFrontRightLeg.rotationPointY = 15.8F;
			ocelotFrontRightLeg.rotationPointZ = -7F;
			ocelotBackLeftLeg.rotateAngleX = -((float) Math.PI / 2F);
			ocelotBackLeftLeg.rotationPointY = 21F;
			ocelotBackLeftLeg.rotationPointZ = 1F;
			ocelotBackRightLeg.rotateAngleX = -((float) Math.PI / 2F);
			ocelotBackRightLeg.rotationPointY = 21F;
			ocelotBackRightLeg.rotationPointZ = 1F;
			state = 3;
		} else {
			state = 1;
		}
