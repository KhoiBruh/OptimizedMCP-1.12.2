...
public class ModelVillager extends ModelBase {
	...
	public ModelVillager(float scale, float p_i1164_2_, int width, int height) {
		...
		villagerNose.setRotationPoint(0F, p_i1164_2_ - 2F, 0F);
		villagerNose.setTextureOffset(24, 0).addBox(-1F, -1F, -6F, 2, 4, 2, scale);
		villagerHead.addChild(villagerNose);
		villagerBody = (new ModelRenderer(this)).setTextureSize(width, height);
		villagerBody.setRotationPoint(0F, 0F + p_i1164_2_, 0F);
		villagerBody.setTextureOffset(16, 20).addBox(-4F, 0F, -3F, 8, 12, 6, scale);
		villagerBody.setTextureOffset(0, 38).addBox(-4F, 0F, -3F, 8, 18, 6, scale + 0.5F);
		villagerArms = (new ModelRenderer(this)).setTextureSize(width, height);
		villagerArms.setRotationPoint(0F, 0F + p_i1164_2_ + 2F, 0F);
		villagerArms.setTextureOffset(44, 22).addBox(-8F, -2F, -2F, 4, 8, 4, scale);
		villagerArms.setTextureOffset(44, 22).addBox(4F, -2F, -2F, 4, 8, 4, scale);
		villagerArms.setTextureOffset(40, 38).addBox(-4F, 2F, -2F, 8, 4, 4, scale);
		rightVillagerLeg = (new ModelRenderer(this, 0, 22)).setTextureSize(width, height);
		rightVillagerLeg.setRotationPoint(-2F, 12F + p_i1164_2_, 0F);
		rightVillagerLeg.addBox(-2F, 0F, -2F, 4, 12, 4, scale);
		leftVillagerLeg = (new ModelRenderer(this, 0, 22)).setTextureSize(width, height);
		leftVillagerLeg.mirror = true;
		leftVillagerLeg.setRotationPoint(2F, 12F + p_i1164_2_, 0F);
		leftVillagerLeg.addBox(-2F, 0F, -2F, 4, 12, 4, scale);
	}
