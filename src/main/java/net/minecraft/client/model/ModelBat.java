...
public class ModelBat extends ModelBase {
	...
	public ModelBat() {
		...
		batHead.addBox(-3F, -3F, -3F, 6, 6, 6);
		ModelRenderer modelrenderer = new ModelRenderer(this, 24, 0);
		modelrenderer.addBox(-4F, -6F, -2F, 3, 4, 1);
		batHead.addChild(modelrenderer);
		ModelRenderer modelrenderer1 = new ModelRenderer(this, 24, 0);
		modelrenderer1.mirror = true;
		modelrenderer1.addBox(1F, -6F, -2F, 3, 4, 1);
		batHead.addChild(modelrenderer1);
		batBody = new ModelRenderer(this, 0, 16);
		batBody.addBox(-3F, 4F, -3F, 6, 12, 6);
		batBody.setTextureOffset(0, 34).addBox(-5F, 16F, 0F, 10, 6, 1);
		batRightWing = new ModelRenderer(this, 42, 0);
		batRightWing.addBox(-12F, 1F, 1.5F, 10, 16, 1);
		batOuterRightWing = new ModelRenderer(this, 24, 16);
		batOuterRightWing.setRotationPoint(-12F, 1F, 1.5F);
		batOuterRightWing.addBox(-8F, 1F, 0F, 8, 12, 1);
		batLeftWing = new ModelRenderer(this, 42, 0);
		batLeftWing.mirror = true;
		batLeftWing.addBox(2F, 1F, 1.5F, 10, 16, 1);
		batOuterLeftWing = new ModelRenderer(this, 24, 16);
		batOuterLeftWing.mirror = true;
		batOuterLeftWing.setRotationPoint(12F, 1F, 1.5F);
		batOuterLeftWing.addBox(0F, 1F, 0F, 8, 12, 1);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
		...
		if (((EntityBat) entityIn).getIsBatHanging()) {
			...
			batHead.setRotationPoint(0F, -2F, 0F);
			batRightWing.setRotationPoint(-3F, 0F, 3F);
			batLeftWing.setRotationPoint(3F, 0F, 3F);
