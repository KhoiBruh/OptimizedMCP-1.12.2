...
public class ModelBed extends ModelBase {
	...
	public ModelBed() {
		...
		headPiece.addBox(0F, 0F, 0F, 16, 16, 6, 0F);
		footPiece = new ModelRenderer(this, 0, 22);
		footPiece.addBox(0F, 0F, 0F, 16, 16, 6, 0F);
		...
		legs[0].addBox(0F, 6F, -16F, 3, 3, 3);
		legs[1].addBox(0F, 6F, 0F, 3, 3, 3);
		legs[2].addBox(-16F, 6F, -16F, 3, 3, 3);
		legs[3].addBox(-16F, 6F, 0F, 3, 3, 3);
