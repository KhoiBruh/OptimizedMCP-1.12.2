...
public class ModelArmorStand extends ModelArmorStandArmor {
	...
	public ModelArmorStand(float modelSize) {
		...
		bipedBody.addBox(-6F, 0F, -1.5F, 12, 3, 3, modelSize);
		bipedBody.setRotationPoint(0F, 0F, 0F);
		bipedRightArm = new ModelRenderer(this, 24, 0);
		bipedRightArm.addBox(-2F, -2F, -1F, 2, 12, 2, modelSize);
		bipedRightArm.setRotationPoint(-5F, 2F, 0F);
		bipedLeftArm = new ModelRenderer(this, 32, 16);
		bipedLeftArm.mirror = true;
		bipedLeftArm.addBox(0F, -2F, -1F, 2, 12, 2, modelSize);
		bipedLeftArm.setRotationPoint(5F, 2F, 0F);
		bipedRightLeg = new ModelRenderer(this, 8, 0);
		bipedRightLeg.addBox(-1F, 0F, -1F, 2, 11, 2, modelSize);
		bipedRightLeg.setRotationPoint(-1.9F, 12F, 0F);
		bipedLeftLeg = new ModelRenderer(this, 40, 16);
		bipedLeftLeg.mirror = true;
		bipedLeftLeg.addBox(-1F, 0F, -1F, 2, 11, 2, modelSize);
		bipedLeftLeg.setRotationPoint(1.9F, 12F, 0F);
		standRightSide = new ModelRenderer(this, 16, 0);
		standRightSide.addBox(-3F, 3F, -1F, 2, 7, 2, modelSize);
		standRightSide.setRotationPoint(0F, 0F, 0F);
		standRightSide.showModel = true;
		standLeftSide = new ModelRenderer(this, 48, 16);
		standLeftSide.addBox(1F, 3F, -1F, 2, 7, 2, modelSize);
		standLeftSide.setRotationPoint(0F, 0F, 0F);
		standWaist = new ModelRenderer(this, 0, 48);
		standWaist.addBox(-4F, 10F, -1F, 8, 2, 2, modelSize);
		standWaist.setRotationPoint(0F, 0F, 0F);
		standBase = new ModelRenderer(this, 0, 32);
		standBase.addBox(-6F, 11F, -6F, 12, 1, 12, modelSize);
		standBase.setRotationPoint(0F, 12F, 0F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
		...
		if (entityIn instanceof EntityArmorStand entityarmorstand) {
			...
			bipedLeftLeg.setRotationPoint(1.9F, 12F, 0F);
			bipedRightLeg.setRotationPoint(-1.9F, 12F, 0F);
			standRightSide.rotateAngleX = 0.017453292F * entityarmorstand.getBodyRotation().x();
			standRightSide.rotateAngleY = 0.017453292F * entityarmorstand.getBodyRotation().y();
			standRightSide.rotateAngleZ = 0.017453292F * entityarmorstand.getBodyRotation().z();
			standLeftSide.rotateAngleX = 0.017453292F * entityarmorstand.getBodyRotation().x();
			standLeftSide.rotateAngleY = 0.017453292F * entityarmorstand.getBodyRotation().y();
			standLeftSide.rotateAngleZ = 0.017453292F * entityarmorstand.getBodyRotation().z();
			standWaist.rotateAngleX = 0.017453292F * entityarmorstand.getBodyRotation().x();
			standWaist.rotateAngleY = 0.017453292F * entityarmorstand.getBodyRotation().y();
			standWaist.rotateAngleZ = 0.017453292F * entityarmorstand.getBodyRotation().z();
			standBase.rotateAngleX = 0F;
			standBase.rotateAngleY = 0.017453292F * -entityIn.rotationYaw;
			standBase.rotateAngleZ = 0F;
		}
	}
