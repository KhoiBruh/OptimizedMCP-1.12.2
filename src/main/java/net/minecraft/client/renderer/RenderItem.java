...
public class RenderItem implements IResourceManagerReloadListener {
	...
	private void registerItems() {
		...
		registerBlock(Blocks.MONSTER_EGG, BlockSilverfish.Type.CHISELED_STONEBRICK.getMetadata(), "chiseled_brick_monster_egg");
		registerBlock(Blocks.MONSTER_EGG, BlockSilverfish.Type.COBBLESTONE.getMetadata(), "cobblestone_monster_egg");
		registerBlock(Blocks.MONSTER_EGG, BlockSilverfish.Type.CRACKED_STONEBRICK.getMetadata(), "cracked_brick_monster_egg");
		registerBlock(Blocks.MONSTER_EGG, BlockSilverfish.Type.MOSSY_STONEBRICK.getMetadata(), "mossy_brick_monster_egg");
		registerBlock(Blocks.MONSTER_EGG, BlockSilverfish.Type.STONE.getMetadata(), "stone_monster_egg");
		registerBlock(Blocks.MONSTER_EGG, BlockSilverfish.Type.STONEBRICK.getMetadata(), "stone_brick_monster_egg");
		...
		registerBlock(Blocks.RED_SANDSTONE, BlockRedSandstone.Type.CHISELED.getMetadata(), "chiseled_red_sandstone");
		registerBlock(Blocks.RED_SANDSTONE, BlockRedSandstone.Type.DEFAULT.getMetadata(), "red_sandstone");
		registerBlock(Blocks.RED_SANDSTONE, BlockRedSandstone.Type.SMOOTH.getMetadata(), "smooth_red_sandstone");
		...
		registerBlock(Blocks.STAINED_GLASS_PANE, DyeColor.LIGHT_BLUE.getMetadata(), "light_blue_stained_glass_pane");
		...
		registerBlock(Blocks.STAINED_HARDENED_CLAY, DyeColor.BLACK.getMetadata(), "black_stained_hardened_clay");
		registerBlock(Blocks.STAINED_HARDENED_CLAY, DyeColor.BLUE.getMetadata(), "blue_stained_hardened_clay");
		registerBlock(Blocks.STAINED_HARDENED_CLAY, DyeColor.BROWN.getMetadata(), "brown_stained_hardened_clay");
		...
		registerBlock(Blocks.STAINED_HARDENED_CLAY, DyeColor.GREEN.getMetadata(), "green_stained_hardened_clay");
		registerBlock(Blocks.STAINED_HARDENED_CLAY, DyeColor.LIGHT_BLUE.getMetadata(), "light_blue_stained_hardened_clay");
		registerBlock(Blocks.STAINED_HARDENED_CLAY, DyeColor.LIME.getMetadata(), "lime_stained_hardened_clay");
		registerBlock(Blocks.STAINED_HARDENED_CLAY, DyeColor.MAGENTA.getMetadata(), "magenta_stained_hardened_clay");
		registerBlock(Blocks.STAINED_HARDENED_CLAY, DyeColor.ORANGE.getMetadata(), "orange_stained_hardened_clay");
		registerBlock(Blocks.STAINED_HARDENED_CLAY, DyeColor.PINK.getMetadata(), "pink_stained_hardened_clay");
		registerBlock(Blocks.STAINED_HARDENED_CLAY, DyeColor.PURPLE.getMetadata(), "purple_stained_hardened_clay");
		registerBlock(Blocks.STAINED_HARDENED_CLAY, DyeColor.RED.getMetadata(), "red_stained_hardened_clay");
		registerBlock(Blocks.STAINED_HARDENED_CLAY, DyeColor.SILVER.getMetadata(), "silver_stained_hardened_clay");
		registerBlock(Blocks.STAINED_HARDENED_CLAY, DyeColor.WHITE.getMetadata(), "white_stained_hardened_clay");
		registerBlock(Blocks.STAINED_HARDENED_CLAY, DyeColor.YELLOW.getMetadata(), "yellow_stained_hardened_clay");
		...
		registerBlock(Blocks.STONE_SLAB2, BlockStoneSlabNew.Type.RED_SANDSTONE.getMetadata(), "red_sandstone_slab");
		...
		registerBlock(Blocks.BROWN_MUSHROOM_BLOCK, BlockHugeMushroom.Type.ALL_INSIDE.getMetadata(), "brown_mushroom_block");
		registerBlock(Blocks.RED_MUSHROOM_BLOCK, BlockHugeMushroom.Type.ALL_INSIDE.getMetadata(), "red_mushroom_block");
