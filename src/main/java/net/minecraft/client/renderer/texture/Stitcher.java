...
public class Stitcher
{
    ...
    {
        Stitcher.Holder[] astitcher$holder = (Stitcher.Holder[]) setStitchHolders.toArray(new Stitcher.Holder[setStitchHolders.size()]);
            ...
            else
            {
                ...
                if (i <= width && j <= height)
                {
                    ...
                    else
                    {
                        if (subSlots == null)
                        {
                            subSlots = Lists.<Stitcher.Slot>newArrayListWithCapacity(1);
