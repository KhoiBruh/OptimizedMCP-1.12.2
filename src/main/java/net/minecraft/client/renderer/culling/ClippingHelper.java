...
public class ClippingHelper {
	...
	public boolean isBoxInFrustum(double p_78553_1_, double p_78553_3_, double p_78553_5_, double p_78553_7_, double p_78553_9_, double p_78553_11_) {
		...
		for (int i = 0; i < 6; ++i) {
			...
			if (dot(afloat, p_78553_1_, p_78553_3_, p_78553_5_) <= 0D && dot(afloat, p_78553_7_, p_78553_3_, p_78553_5_) <= 0D && dot(afloat, p_78553_1_, p_78553_9_, p_78553_5_) <= 0D && dot(afloat, p_78553_7_, p_78553_9_, p_78553_5_) <= 0D && dot(afloat, p_78553_1_, p_78553_3_, p_78553_11_) <= 0D && dot(afloat, p_78553_7_, p_78553_3_, p_78553_11_) <= 0D && dot(afloat, p_78553_1_, p_78553_9_, p_78553_11_) <= 0D && dot(afloat, p_78553_7_, p_78553_9_, p_78553_11_) <= 0D) {
				return false;
			}
		}
