...
public class GuiScreenAdvancements extends GuiScreen implements ClientAdvancementManager.IListener
{
    ...
    public void initGui()
    {
        ...
        {
            clientAdvancementManager.setSelectedTab(((GuiAdvancementTab) tabs.values().iterator().next()).getAdvancement(), true);
        }
        else
        {
    ...
    {
        clientAdvancementManager.setListener((ClientAdvancementManager.IListener)null);
