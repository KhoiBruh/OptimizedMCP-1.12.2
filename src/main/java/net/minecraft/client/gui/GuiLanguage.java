...
public class GuiLanguage extends GuiScreen {
	...
	public void initGui() {
		...
		forceUnicodeFontBtn = addButton(new GuiOptionButton(100, width / 2 - 155, height - 38, GameSettings.Options.FORCE_UNICODE_FONT, game_settings_3.getKeyBinding(GameSettings.Options.FORCE_UNICODE_FONT)));
		confirmSettingsBtn = addButton(new GuiOptionButton(6, width / 2 - 155 + 160, height - 38, I18n.format("gui.done")));
			...
			switch (button.id) {
				...
				case 100:
					if (button instanceof GuiOptionButton) {
						...
						int j = mc.scaledResolution.getScaledHeight();
