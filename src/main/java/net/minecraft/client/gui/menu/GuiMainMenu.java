...
import net.minecraft.client.gui.component.GuiButtonLanguage;
import net.minecraft.client.gui.game.GuiWinGame;
import net.minecraft.client.gui.option.GuiLanguage;
