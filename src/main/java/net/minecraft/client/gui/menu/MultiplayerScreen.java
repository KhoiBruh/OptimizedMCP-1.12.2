...
import net.minecraft.client.multiplayer.ConnectingScreen;
...
public class MultiplayerScreen extends Screen {
	...
	public void createButtons() {
		...
		buttons.add(new Button(4, width / 2 - 50, height - 52, 100, 20, I18n.format("selectServer.direct")));
		buttons.add(new Button(3, width / 2 + 4 + 50, height - 52, 100, 20, I18n.format("selectServer.add")));
		buttons.add(new Button(8, width / 2 + 4, height - 28, 70, 20, I18n.format("selectServer.refresh")));
		buttons.add(new Button(0, width / 2 + 4 + 76, height - 28, 75, 20, I18n.format("gui.cancel")));
		...
		if (button.enabled) {
			...
			if (button.id == 2 && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
				...
				if (s4 != null) {
					...
					YesNoScreen guiyesno = new YesNoScreen(this, s, s1, s2, s3, serverListSelector.getSelected());
				...
				mc.displayScreen(new ServerListScreen(this, selectedServer));
			} else if (button.id == 3) {
				addingServer = true;
				selectedServer = new ServerData(I18n.format("selectServer.defaultName"), "", false);
				mc.displayScreen(new AddServerScreen(this, selectedServer));
