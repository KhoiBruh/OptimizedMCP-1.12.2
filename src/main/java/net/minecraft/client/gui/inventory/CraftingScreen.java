...
public class CraftingScreen extends ContainerScreen implements IRecipeShownListener {
	...
	public void init() {
		...
		recipeButton = new ImageButton(10, guiLeft + 5, height / 2 - 49, 20, 18, 0, 168, 19, CRAFTING_TABLE_GUI_TEXTURES);
