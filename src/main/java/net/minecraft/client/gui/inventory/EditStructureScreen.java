...
public class EditStructureScreen extends Screen {
	...
	public void init() {
		...
		cancelButton = addButton(new Button(1, width / 2 + 4, 210, 150, 20, I18n.format("gui.cancel")));
		saveButton = addButton(new Button(9, width / 2 + 4 + 100, 185, 50, 20, I18n.format("structure_block.button.save")));
		loadButton = addButton(new Button(10, width / 2 + 4 + 100, 185, 50, 20, I18n.format("structure_block.button.load")));
		modeButton = addButton(new Button(18, width / 2 - 4 - 150, 185, 50, 20, "MODE"));
		detectSizeButton = addButton(new Button(19, width / 2 + 4 + 100, 120, 50, 20, I18n.format("structure_block.button.detect_size")));
		showEntitiesButton = addButton(new Button(20, width / 2 + 4 + 100, 160, 50, 20, "ENTITIES"));
		mirrorButton = addButton(new Button(21, width / 2 - 20, 185, 40, 20, "MIRROR"));
		showAirButton = addButton(new Button(22, width / 2 + 4 + 100, 80, 50, 20, "SHOWAIR"));
		showBoundingBoxButton = addButton(new Button(23, width / 2 + 4 + 100, 80, 50, 20, "SHOWBB"));
		rotateZeroDegreesButton = addButton(new Button(11, width / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20, "0"));
		rotateNinetyDegreesButton = addButton(new Button(12, width / 2 - 1 - 40 - 20, 185, 40, 20, "90"));
		rotate180DegreesButton = addButton(new Button(13, width / 2 + 1 + 20, 185, 40, 20, "180"));
		rotate270DegressButton = addButton(new Button(14, width / 2 + 1 + 40 + 1 + 20, 185, 40, 20, "270"));
