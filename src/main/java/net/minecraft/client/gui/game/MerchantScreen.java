...
public class MerchantScreen extends ContainerScreen {
	 ...
	 */
	private MerchantScreen.MerchantButton nextButton;
	/**
	 * Returns to the previous Merchant recipe if one is applicable.
	 */
	private MerchantScreen.MerchantButton previousButton;
	/**
