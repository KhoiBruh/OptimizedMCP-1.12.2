...
public class BookScreen extends Screen {
	...
	private BookScreen.NextPageButton buttonNextPage;
	private BookScreen.NextPageButton buttonPreviousPage;
	...
	public void init() {
		...
		if (bookIsUnsigned) {
			buttonSign = addButton(new Button(3, width / 2 - 100, 196, 98, 20, I18n.format("book.signButton")));
			buttonDone = addButton(new Button(0, width / 2 + 2, 196, 98, 20, I18n.format("gui.done")));
			buttonFinalize = addButton(new Button(5, width / 2 - 100, 196, 98, 20, I18n.format("book.finalizeButton")));
			buttonCancel = addButton(new Button(4, width / 2 + 2, 196, 98, 20, I18n.format("gui.cancel")));
		} else {
			buttonDone = addButton(new Button(0, width / 2 - 100, 196, 200, 20, I18n.format("gui.done")));
		}
