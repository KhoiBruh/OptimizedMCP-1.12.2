...
public class TeleportToPlayer implements ISpectatorMenuView, ISpectatorMenuObject {
	...
	private static final Ordering<NetworkPlayerInfo> PROFILE_ORDER = Ordering.from((p_compare_1_, p_compare_2_) -> ComparisonChain.start()
	                                                                                                                              .compare(p_compare_1_.getGameProfile()
	                                                                                                                                                   .getId(), p_compare_2_.getGameProfile()
	                                                                                                                                                                         .getId())
	                                                                                                                              .result());
