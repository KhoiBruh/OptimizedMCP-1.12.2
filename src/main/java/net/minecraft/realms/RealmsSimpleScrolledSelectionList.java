...
public class RealmsSimpleScrolledSelectionList
{
    ...
    {
        proxy = new GuiSimpleScrolledSelectionListProxy(this, width, height, top, bottom, slotHeight);
    }
    ...
    public int ym()
    {
        return proxy.getMouseY();
    }

    public int xm()
    {
        return proxy.getMouseX();
    }
    ...
    {
        return proxy.getWidth() / 2 + 124;
    }

    public void mouseEvent()
    {
        proxy.handleMouseInput();
    }
