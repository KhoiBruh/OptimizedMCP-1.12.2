...
public class ItemBoat extends Item {
	...
	public TypedActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, Hand handIn) {
		...
		float f3 = Maths.cos(-f2 * 0.017453292F - (float) Math.PI);
		float f4 = Maths.sin(-f2 * 0.017453292F - (float) Math.PI);
		float f5 = -Maths.cos(-f1 * 0.017453292F);
		float f6 = Maths.sin(-f1 * 0.017453292F);
		float f7 = f4 * f5;
		float f8 = f3 * f5;
		double d3 = 5D;
