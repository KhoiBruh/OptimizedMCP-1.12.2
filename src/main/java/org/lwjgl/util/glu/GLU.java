...
public final class GLU {
    ...
    public static boolean gluProject(float objX, float objY, float objZ, FloatBuffer model, FloatBuffer proj, IntBuffer view, FloatBuffer objPos) {
    ...
    public static boolean gluUnProject(float winX, float winY, float winZ, FloatBuffer model, FloatBuffer proj, IntBuffer view, FloatBuffer objPos) {
        float[] m = new float[16];
        float[] p = new float[16];
        model.get(m);
        proj.get(p);
